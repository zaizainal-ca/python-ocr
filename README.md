...
public function processMyKadOcr(Request $request)
{
    ...
    try {
        ...
        )->post('http://localhost:8000/api/ocr/mykad');
...
* **Memory Allocation (Warm/Idle)**: 4 GB * 730 hours/month * $0.007/GB-hour = **$20.44**.
...
* *Tip:* Switching to an ARM64-based instance (like `t4g.medium`) reduces the cost to **~$24.50/month**.
